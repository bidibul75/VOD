...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 23 jan. 2024 à 11:51
...
INSERT INTO `utilisateur` (`idUtilisateur`, `login`, `motDePasse`, `nom`, `prenom`, `adresseUtilisateur`, `codePostalUtilisateur`, `villeUtilisateur`) VALUES
(1, 'root', 'root', 'Root', 'Rooting', 'abc@xyz.fr', '75001', 'Paris');
